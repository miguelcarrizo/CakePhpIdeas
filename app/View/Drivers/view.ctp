                        ...
                        <section id="lateralcontenido">
                            <div class="inner4">
                                ...
                                <div id="contenido">
                                        ...
                                        <div class="datagrid">
                                                <table>
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                          <td><?php echo __('Valorización'); ?></td>
                                                          <td><?php echo h($driver['Driver']['value']); ?></td>
                                                        </tr>
                                                        <tr>
                                                          <td><?php echo __('Usuario'); ?></td>
                                                          <td><?php echo h($driver['Driver']['id_user']); ?></td>
                                                        </tr>
                                                        <tr>
                                                          <td><?php echo __('Periodo'); ?></td>
                                                          <td><?php echo h($driver['Driver']['id_period']); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>   
                                        </div>
                                    ...
                                    <div class="actions">
                                        <ul>
                                        <li><?php echo $this->Html->link(__('EDITAR RELACION'), array('action' => 'edit', $driver['Driver']['id']), array( 'class' => 'botonForm')); ?> </li>
                                        <li><?php echo $this->Form->postLink(__('ELIMINAR'), array('action' => 'delete', $driver['Driver']['id']), array( 'class' => 'botonForm'), __('Are you sure you want to delete # %s?', $driver['Driver']['id'])); ?> </li>
