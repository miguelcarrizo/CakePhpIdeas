                        ...
                        <section id="lateralcontenido">
                            <div class="inner4">
                                ...
                                <div id="contenido">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><?php echo h($driverRating['DriverRating']['id']); ?></td>
                                                      </tr>
                                                      <tr>
                                                        <td><?php echo __('Valor de driver'); ?></td>
                                                        <td><?php echo h($driverRating['DriverRating']['rating']); ?></td>
                                                      </tr>
                                                </tbody>
                                            </table>   
                                        </div>
                                    ...
                                    <div class="actions">
                                        <ul>
                                        <li><?php echo $this->Html->link(__('EDITAR ROL'), array('action' => 'edit', $driverRating['DriverRating']['id']), array( 'class' => 'botonForm')); ?> </li>
                                        <li><?php echo $this->Form->postLink(__('ELIMINAR'), array('action' => 'delete', $driverRating['DriverRating']['id']), array( 'class' => 'botonForm'), __('Are you sure you want to delete # %s?', $driverRating['DriverRating']['id'])); ?> </li>
