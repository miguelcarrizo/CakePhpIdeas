                        ...
                        <section id="lateralcontenido">
                            <div class="inner4">
                                ...
                                <div id="contenido">
                                        ...
                                        <div class="datagrid">
                                            <table>
                                                <tbody>
                                                  ...
                                                  <tr>
                                                    <td><?php echo __('Fecha Inicio'); ?></td>
                                                    <td><?php echo h($period['Period']['iniciation_date']); ?></td>
                                                  </tr>
                                                  <tr>
                                                    <td><?php echo __('Fecha Termino'); ?></td>
                                                    <td><?php echo h($period['Period']['final_date']); ?></td>
                                                  </tr>
                                                  <tr>
                                                    <td><?php echo __('Usuario'); ?></td>
                                                    <td><?php echo h($period['Period']['id_user']); ?></td>
                                                  </tr>    
                                                </tbody>
                                            </table>   
                                        </div>
                                    ...
                                    <div class="actions">
                                        <ul>
                                        <li><?php echo $this->Html->link(__('EDITAR PERIODO'), array('action' => 'edit', $period['Period']['id']), array( 'class' => 'botonForm')); ?> </li>
                                        <li><?php echo $this->Form->postLink(__('ELIMINAR'), array('action' => 'delete', $period['Period']['id']), array( 'class' => 'botonForm'), __('Esta seguro de eliminar el periodo # %s?', $period['Period']['id'])); ?> </li>
