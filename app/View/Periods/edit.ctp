    ...
    <div class="col-md-6">
        ...
        <div class="box box-primary">
            ...
            <div class="box-footer">
                <?php 
                    echo $this->Form->submit(__('Editar Periodo',true), array('class'=>'btn btn-primary')); 
                    echo $this->Form->end();
                ?>
            </div>
        </div><!-- /.box -->
        <?php echo $this->Form->postLink(__('ELIMINAR'), array('action' => 'delete', $this->Form->value('Period.id')), array( 'class' => 'btn btn-primary btn-block'), __('Estas seguro de eliminar el periodo # %s?', $this->Form->value('Period.id'))); ?>
