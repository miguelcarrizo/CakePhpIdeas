                        ...
                        <section id="lateralcontenido">
                            <div class="inner4">
                                ...
                                <div id="contenido">
                                            ...
                                            <table>
                                                <tbody>
                                                  <tr>
                                                    ...
                                                    <td><?php echo h($scenario['Scenario']['id']); ?></td>
                                                  </tr>
                                                  <tr>
                                                    <td><?php echo __('Valor'); ?></td>
                                                    <td><?php echo h($scenario['Scenario']['value']); ?></td>
                                                  </tr>
                                                  <tr>
                                                    <td><?php echo __('Estado'); ?></td>
                                                    <td><?php echo h($scenario['Scenario']['status']); ?></td>
                                                  </tr>
                                                  <tr>
                                                    <td><?php echo __('Idea'); ?></td>
                                                    <td><?php echo h($scenario['Scenario']['id_idea']); ?></td>
                                                  </tr>
                                                  <tr>
                                                    <td><?php echo __('Driver'); ?></td>
                                                    <td><?php echo h($scenario['Scenario']['id_driver']); ?></td>
                                                  </tr>  
                                                </tbody>
                                            </table>   
                                        </div>
                                    ...
                                    <div class="actions">
                                        <ul>
                                        <li><?php echo $this->Html->link(__('EDITAR PERIODO'), array('action' => 'edit', $scenario['Scenario']['id']), array( 'class' => 'botonForm')); ?> </li>
                                        <li><?php echo $this->Form->postLink(__('ELIMINAR'), array('action' => 'delete', $scenario['Scenario']['id']), array( 'class' => 'botonForm'), __('Esta seguro de eliminar el escenario # %s?', $scenario['Scenario']['id'])); ?> </li>
