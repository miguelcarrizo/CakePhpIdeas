    ...
    <div class="col-md-6">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Editar Driver</h3>
            </div><!-- /.box-header -->
            <!-- form start -->
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    foreach ($options as $option):
                        if($option['Period']['id']==$this->Form->value('Driver.id_period')){
                             echo '<option selected="true"  value="'.$option['Period']['id'].'">';
                                echo $option['Period']['id'].' - '.$option['Period']['iniciation_date'].'-'.$option['Period']['final_date'];
                            echo '</option>';
                        }else{
            ...
            <div class="box-footer">
                <?php 
                    echo $this->Form->submit(__('Editar Driver',true), array('class'=>'btn btn-primary')); 
                    echo $this->Form->end();
                ?>
            </div>
        </div><!-- /.box -->
